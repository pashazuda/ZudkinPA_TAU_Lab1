...
z = -625 * w ** 6 + 5312 * I * w ** 5 + (1.279 * 10 ** (+4)) * w ** 4 - (1.854 * 10 ** (+4)) * I * w ** 3 - (
            5.252 * 10 ** (+4)) * w ** 2 + (1.228 * 10 ** (+4)) * I * w + 485
...
for k in range(-1000000, 1000000):
    ...
    for i in range(dlina):
        dic["%s" % i] = r[i]
    #matrix = [[dic["1"], dic["3"], dic["5"], 0, 0, 0],
              #[dic["0"], dic["2"], dic["4"], dic["6"], 0, 0],
              #[0, dic["1"], dic["3"], dic["5"], 0, 0],
              #[0, dic["0"], dic["2"], dic["4"], dic["6"], 0],
              #[0, 0, dic["1"], dic["3"], dic["5"], 0],
              #[0, 0, dic["0"], dic["2"], dic["4"], dic["6"]]]
    if dic["1"] == 0:
