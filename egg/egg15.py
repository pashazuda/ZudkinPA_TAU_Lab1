...
print('3. Прямые оценки качества переходного процесса')
...
print('4. По распределению корней на комплексной плоскости замкнутой САУ')
...
# Вывод дзначений для пункта 4
print('5. По распределению корней на комплексной плоскости замкнутой САУ')
